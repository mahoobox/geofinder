...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow flex flex-col items-center justify-center bg-background p-4 sm:p-6 md:p-8">
      ...
      <footer className="w-full text-center p-4">
        <p className="text-muted-foreground text-sm">
          a tool by <Link href="https://mauricio-morales.com/" target="_blank" rel="noopener noreferrer" className="font-semibold text-primary hover:underline">MahooBox</Link>
        </p>
      </footer>
    </div>
  );
